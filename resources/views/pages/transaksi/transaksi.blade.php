                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="text-white" style="font-weight: 700;
                                                    font-size: 21px;
                                                    line-height: 29px;">
                            Segera Selesaikan Pembayaranmu!</div>
                          <div class="text-white mb-3" style="font-weight: 400;
                                                    font-size: 15px;
                                                    line-height: 20px;">
                          ...
                          <div class="d-flex align-items-center mt-2">
                            <div style="font-weight: 600;
                                                        font-size: 15px;
                                                        line-height: 20px; color: #C2C2D9;">
                              Sebelum : <small class="text-white" style="font-weight: 600;
                                                        font-size: 15px;
                          ...
                          <div class="row mt-4 ">
                            <div class="col-md-6">
                              <div class="card m-0 p-3 " style="background-color: #35354F">
                                      ...
                                      <svg width="64" height="22" viewBox="0 0 64 22" fill="none"
                                        ...
                                        <defs>
                                          <clipPath id="clip0_4306_8212">
                                            <rect width="64" height="20.051" fill="white"
                            ...
                            <div class="mt-4 mb-1" style="font-weight: 600;
                                                        font-size: 15px;
                                                        line-height: 20px; color: #C2C2D9;">
